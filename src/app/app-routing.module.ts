...
const routes: Routes = [
  ...
  { path: 'tips&facts', loadChildren: () => import('./products/blog/blog.module').then(m => m.BlogModule) },
  { path: 'tips&facts/:id', loadChildren: () => import('./products/blog/blog.module').then(m => m.BlogModule) },
  ...
  { path: 'flash/:id', loadChildren: () => import('./products/flash/flash.module').then(m => m.FlashModule) },
  { path: 'flash', loadChildren: () => import('./products/flash/flash.module').then(m => m.FlashModule) }, 
  { path: 'quickorderproducts/:id', loadChildren: () => import('./products/flash/flash.module').then(m => m.FlashModule) },
  ...
  { path: 'combo', loadChildren: () => import('./products/combo/combo.module').then(m => m.ComboModule) },
