...
@Component({
  selector: 'app-subscribedprod',
  templateUrl: './subscribedprod.component.html',
  styleUrls: ['./subscribedprod.component.css'],
  providers: [NgbRatingConfig,ToastrService],
})
export class SubscribedprodComponent implements OnInit {
